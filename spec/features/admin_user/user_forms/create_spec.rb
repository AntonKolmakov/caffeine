...
feature 'admin creates new user form' do
  scenario do
    ...
    fill_in I18n.t('simple_form.labels.user_form.name'), with: 'My first dynamic form'
    fill_in I18n.t('simple_form.labels.user_form.email'), with: Faker::Internet.safe_email
    fill_in I18n.t('simple_form.labels.user_form.alias'), with: 'supalias'
